...
#recognize the barcode in the image
def decode(image):
...
'''
    the main idea of barcode detection is to extract the barcode zone in the image
    and use the pyzbar package to do the translation of the code
...
while(1):
    ...
    if len(cnts):
        ...
        #select the zone of the barcode
